...
신뢰도는 100%로  양지(치마)가 포함되어 있으면 업진이 포함되어있는 비율이 100%라는 의미입니다.   
향상도는 75로써 무연관성을 나타내는 수치인 1과 비교해보았을 때 매우 높은 양의 상관관계(같이 구매할 확률이 매우 높은)를 나타냅니다.   
첫번째 행의 결과는 업진과 치마살이 양지(양지머리, 업진살, 차돌백이, 치맛살)에 같이 속해 있기 때문으로 사료됩니다.   

이분석에서 가장 주목해야할 점은 15, 16번 항목인 갈비와 사태입니다.

![image](https://user-images.githubusercontent.com/71205453/109747182-fd433980-7c19-11eb-98c2-8471da9f2514.png)   

**갈비와 사태는 서로 붙어 있는 부위가 아님에도 불구하고 48.3이라는 향상도를 보여 높은 구매 연관성을 나타내고 있습니다.   
따라서 해당 상품 담당자는 갈비와 사태를 교차판매 전략, 상품진열 레이아웃, 패키지 상품 기획 등의 방법을 통해 상품을 구성한다면   
더 많은 판매량을 달성 할 수 있을 것 입니다.***
